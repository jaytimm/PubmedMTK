...
> A clean & un-adulterated version of MeSH ontology as data frame.  Included in the R package `PumbedMTK`. Based on two files: `desc2019.xml` & `mtrees2020.bin`; available via nlm.nih.gov [here](https://www.nlm.nih.gov/databases/download/mesh.html).
