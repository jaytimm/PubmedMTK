...
# Load functions
fns_location <- 'functions/'
R.utils::sourceDirectory(fns_location)

if (!require("pacman")) install.packages("pacman")
pacman::p_load(text2vec, data.table, quanteda, 
               rentrez, XML, xml2, RCurl, textmineR, 
               tidytext, text2vec, tm, reshape2, 
               tokenizers, pluralize, Matrix.utils, # function depends
               magrittr, dplyr, tidyr, ggplot2) # analysis
```
...
*Note: Having a NCBI key becomes useful (and perhaps necessary) when performing larger queries, and creating larger sets of batch files.*   
...
```{r}
dtm_to_sparse <- function(data, row, column, value, ...) {
